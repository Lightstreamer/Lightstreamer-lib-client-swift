...
final class UpdateTests: BaseTestCase {
    ...
    func testNil() {
        ...
        let sub = Subscription(.RAW, items: ["i1", "i2"], fields: ["f1", "f2", "f3", "f4"])
        ...
        asyncAssert {
            ...
            XCTAssertEqual(nil, u.valueWithFieldPos(1))
            XCTAssertEqual(nil, u.valueWithFieldPos(2))
            XCTAssertEqual("", u.valueWithFieldPos(3))
            XCTAssertEqual("z", u.valueWithFieldPos(4))
            XCTAssertEqual(nil, u.valueWithFieldName("f1"))
            XCTAssertEqual(nil, u.valueWithFieldName("f2"))
            XCTAssertEqual("", u.valueWithFieldName("f3"))
            XCTAssertEqual("z", u.valueWithFieldName("f4"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(3))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(4))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f1"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f2"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f3"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f4"))
            ...
            XCTAssertEqual(nil, u.valueWithFieldPos(1))
            XCTAssertEqual("n", u.valueWithFieldPos(2))
            XCTAssertEqual(nil, u.valueWithFieldPos(3))
            XCTAssertEqual(nil, u.valueWithFieldPos(4))
            XCTAssertEqual(nil, u.valueWithFieldName("f1"))
            XCTAssertEqual("n", u.valueWithFieldName("f2"))
            XCTAssertEqual(nil, u.valueWithFieldName("f3"))
            XCTAssertEqual(nil, u.valueWithFieldName("f4"))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(3))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(4))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("f1"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f2"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f3"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f4"))
        }
    ...
    func testRAW() {
        ...
        let sub = Subscription(.RAW, items: ["i1", "i2"], fields: ["f1", "f2"])
        sub.addDelegate(subDelegate)
        client.subscribe(sub)
        ...
        asyncAssert {
            ...
            XCTAssertEqual("a", u.valueWithFieldPos(1))
            XCTAssertEqual("b", u.valueWithFieldPos(2))
            XCTAssertEqual("a", u.valueWithFieldName("f1"))
            XCTAssertEqual("b", u.valueWithFieldName("f2"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f1"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f2"))
            ...
            XCTAssertEqual("c", u.valueWithFieldPos(1))
            XCTAssertEqual("d", u.valueWithFieldPos(2))
            XCTAssertEqual("c", u.valueWithFieldName("f1"))
            XCTAssertEqual("d", u.valueWithFieldName("f2"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f1"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f2"))
            ...
            XCTAssertEqual("b", u.valueWithFieldName("f2"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f1"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("f2"))
    ...
    func testMERGE() {
        ...
        let sub = Subscription(.MERGE, items: ["i1", "i2"], fields: ["f1", "f2"])
        sub.addDelegate(subDelegate)
        client.subscribe(sub)
    ...
    func testDISTINCT() {
        ...
        let sub = Subscription(.DISTINCT, items: ["i1", "i2"], fields: ["f1", "f2"])
        sub.addDelegate(subDelegate)
        client.subscribe(sub)
    ...
    func testCOMMAND_ADD() {
        ...
        let sub = Subscription(.COMMAND, items: ["i1", "i2"], fields: ["f1", "f2", "key", "command"])
        sub.requestedSnapshot = .no
        sub.addDelegate(subDelegate)
        client.subscribe(sub)
        ...
        asyncAssert {
            ...
            XCTAssertEqual("a", u.valueWithFieldPos(1))
            XCTAssertEqual("b", u.valueWithFieldPos(2))
            XCTAssertEqual("k1", u.valueWithFieldPos(3))
            XCTAssertEqual("ADD", u.valueWithFieldPos(4))
            XCTAssertEqual("a", u.valueWithFieldName("f1"))
            XCTAssertEqual("b", u.valueWithFieldName("f2"))
            XCTAssertEqual("k1", u.valueWithFieldName("key"))
            XCTAssertEqual("ADD", u.valueWithFieldName("command"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(3))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(4))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f1"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f2"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("key"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("command"))
            ...
            XCTAssertEqual("c", u.valueWithFieldPos(1))
            XCTAssertEqual("d", u.valueWithFieldPos(2))
            XCTAssertEqual("k2", u.valueWithFieldPos(3))
            XCTAssertEqual("ADD", u.valueWithFieldPos(4))
            XCTAssertEqual("c", u.valueWithFieldName("f1"))
            XCTAssertEqual("d", u.valueWithFieldName("f2"))
            XCTAssertEqual("k2", u.valueWithFieldName("key"))
            XCTAssertEqual("ADD", u.valueWithFieldName("command"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(3))
            ...
            XCTAssertEqual("a", u.valueWithFieldPos(1))
            XCTAssertEqual("B", u.valueWithFieldPos(2))
            XCTAssertEqual("k3", u.valueWithFieldPos(3))
            XCTAssertEqual("ADD", u.valueWithFieldPos(4))
            XCTAssertEqual("a", u.valueWithFieldName("f1"))
            XCTAssertEqual("B", u.valueWithFieldName("f2"))
            XCTAssertEqual("k3", u.valueWithFieldName("key"))
            XCTAssertEqual("ADD", u.valueWithFieldName("command"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(3))
    ...
    func testCOMMAND_UPDATE() {
        ...
        asyncAssert {
            ...
            XCTAssertEqual("B", u.valueWithFieldPos(2))
            XCTAssertEqual("k1", u.valueWithFieldPos(3))
            XCTAssertEqual("UPDATE", u.valueWithFieldPos(4))
            XCTAssertEqual("a", u.valueWithFieldName("f1"))
            XCTAssertEqual("B", u.valueWithFieldName("f2"))
            XCTAssertEqual("k1", u.valueWithFieldName("key"))
            XCTAssertEqual("UPDATE", u.valueWithFieldName("command"))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(3))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(4))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("f1"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f2"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("key"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("command"))
        }
    }
    ...
    func testCOMMAND_DELETE() {
        ...
        asyncAssert {
            ...
            XCTAssertEqual(nil, u.valueWithFieldPos(2))
            XCTAssertEqual("k1", u.valueWithFieldPos(3))
            XCTAssertEqual("DELETE", u.valueWithFieldPos(4))
            XCTAssertEqual(nil, u.valueWithFieldName("f1"))
            XCTAssertEqual(nil, u.valueWithFieldName("f2"))
            XCTAssertEqual("k1", u.valueWithFieldName("key"))
            XCTAssertEqual("DELETE", u.valueWithFieldName("command"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(3))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(4))
    ...
    func testCOMMAND2Level_ConnectAndDisconnect() {
        ...
        asyncAssert(after: 0.5) {
            ...
            XCTAssertEqual("a", u.valueWithFieldPos(1))
            XCTAssertEqual("b", u.valueWithFieldPos(2))
            XCTAssertEqual("item1", u.valueWithFieldPos(3))
            XCTAssertEqual("ADD", u.valueWithFieldPos(4))
            XCTAssertEqual(nil, u.valueWithFieldPos(5))
            XCTAssertEqual(nil, u.valueWithFieldPos(6))
            XCTAssertEqual("a", u.valueWithFieldName("f1"))
            XCTAssertEqual("b", u.valueWithFieldName("f2"))
            XCTAssertEqual("item1", u.valueWithFieldName("key"))
            XCTAssertEqual("ADD", u.valueWithFieldName("command"))
            XCTAssertEqual(nil, u.valueWithFieldName("f5"))
            XCTAssertEqual(nil, u.valueWithFieldName("f6"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(3))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(4))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(5))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(6))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f1"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f2"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("key"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("command"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("f5"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("f6"))
            ...
            XCTAssertEqual("item1", u.valueWithFieldPos(3))
            XCTAssertEqual("UPDATE", u.valueWithFieldPos(4))
            XCTAssertEqual("c", u.valueWithFieldPos(5))
            XCTAssertEqual("d", u.valueWithFieldPos(6))
            XCTAssertEqual("a", u.valueWithFieldName("f1"))
            XCTAssertEqual("b", u.valueWithFieldName("f2"))
            XCTAssertEqual("item1", u.valueWithFieldName("key"))
            XCTAssertEqual("UPDATE", u.valueWithFieldName("command"))
            XCTAssertEqual("c", u.valueWithFieldName("f5"))
            XCTAssertEqual("d", u.valueWithFieldName("f6"))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(3))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(4))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(5))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(6))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("f1"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("f2"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("key"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("command"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f5"))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f6"))
