    ...
    func testCONERR_Retry() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_cid=cid&LS_send_sync=false&LS_cause=ws.conerr.4
                """, self.ws.trace)
            XCTAssertEqual("""
                CONNECTING
    ...
    func testEND_Retry() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_keepalive_millis=5000&LS_cid=cid&LS_old_session=sid&LS_send_sync=false&LS_cause=ws.end.41
                """, self.ws.trace)
            XCTAssertEqual("""
                CONNECTING
                CONNECTED:WS-STREAMING
    ...
    func testREQERR_Retry() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_keepalive_millis=5000&LS_cid=cid&LS_old_session=sid&LS_send_sync=false&LS_cause=ws.reqerr.20
                """, self.ws.trace)
            XCTAssertEqual("""
                CONNECTING
                CONNECTED:WS-STREAMING
    ...
    func testTransportTimeout_in_122_Creating() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_cid=cid&LS_send_sync=false&LS_cause=ws.timeout
                """, self.ws.trace)
            XCTAssertEqual("""
                CONNECTING
                DISCONNECTED:WILL-RETRY
    ...
    func testTransportError_in_122_Creating() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_cid=cid&LS_send_sync=false&LS_cause=ws.error
                """, self.ws.trace)
            XCTAssertEqual("""
                CONNECTING
                DISCONNECTED:WILL-RETRY
    ...
    func testWithOptions() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                wsok
                create_session\r
                LS_keepalive_millis=10&LS_inactivity_millis=20&LS_requested_max_bandwidth=30.3&LS_adapter_set=adapter&LS_user=user&LS_cid=cid&LS_cause=api&LS_password=pwd
                """, self.ws.trace)
            XCTAssertEqual("""
                CONNECTING
                """, self.delegate.trace)
