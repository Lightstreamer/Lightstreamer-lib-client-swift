    ...
    func testCONERR_Retry() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_cid=\(LS_TEST_CID)&LS_send_sync=false&LS_cause=ttl.conerr.4
                """, self.io.trace)
            XCTAssertEqual(self.delegatePreamble + """
                CONNECTING
                DISCONNECTED:WILL-RETRY
    ...
    func testCONERR_RetryTTL() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                http.dispose
                http.send http://server/lightstreamer/create_session.txt?LS_protocol=\(TLCP_VERSION)
                LS_ttl_millis=unlimited&LS_polling=true&LS_polling_millis=0&LS_idle_millis=0&LS_cid=\(LS_TEST_CID)&LS_cause=ttl.conerr.5
                """, self.http.trace)
            XCTAssertEqual(self.delegatePreamble + """
                CONNECTING
                DISCONNECTED:WILL-RETRY
    ...
    func testPROG_Mismatch() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_cid=\(LS_TEST_CID)&LS_old_session=sid&LS_send_sync=false&LS_cause=prog.mismatch.100.0
                """, self.io.trace)
            XCTAssertEqual(self.delegatePreamble + """
                CONNECTING
                CONNECTED:STREAM-SENSING
    ...
    func testTransportTimeout_in_140() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                http.dispose
                http.send http://server/lightstreamer/create_session.txt?LS_protocol=\(TLCP_VERSION)
                LS_ttl_millis=unlimited&LS_polling=true&LS_polling_millis=0&LS_idle_millis=0&LS_cid=\(LS_TEST_CID)&LS_cause=ttl.timeout
                """, self.http.trace)
            XCTAssertEqual(self.delegatePreamble + """
                CONNECTING
                DISCONNECTED:WILL-RETRY
    ...
    func testTransportTimeout_in_230_Created_no_Recovery() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_cid=\(LS_TEST_CID)&LS_old_session=sid&LS_send_sync=false&LS_cause=ttl.timeout
                """, self.io.trace)
            XCTAssertEqual(self.delegatePreamble + """
                CONNECTING
                CONNECTED:STREAM-SENSING
    ...
    func testTransportError_in_140() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                http.dispose
                http.send http://server/lightstreamer/create_session.txt?LS_protocol=\(TLCP_VERSION)
                LS_ttl_millis=unlimited&LS_polling=true&LS_polling_millis=0&LS_idle_millis=0&LS_cid=\(LS_TEST_CID)&LS_cause=ttl.error
                """, self.http.trace)
            XCTAssertEqual(self.delegatePreamble + """
                CONNECTING
                DISCONNECTED:WILL-RETRY
    ...
    func testTransportError_in_230_Created_no_Recovery() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_cid=\(LS_TEST_CID)&LS_old_session=sid&LS_send_sync=false&LS_cause=ttl.error
                """, self.io.trace)
            XCTAssertEqual(self.delegatePreamble + """
                CONNECTING
                CONNECTED:STREAM-SENSING
