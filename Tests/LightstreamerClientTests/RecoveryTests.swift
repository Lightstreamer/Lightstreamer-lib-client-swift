    ...
    func testCONERR_Retry() {
        ...
        asyncAssert {
            XCTAssertEqual(self.preamble + """
                ...
                wsok
                create_session\r
                LS_keepalive_millis=5000&LS_cid=\(LS_TEST_CID)&LS_old_session=sid&LS_send_sync=false&LS_cause=recovery.conerr.4
                """, self.io.trace)
            XCTAssertEqual(self.delegatePreamble + """
                DISCONNECTED:TRYING-RECOVERY
                DISCONNECTED:WILL-RETRY
    ...
    func testEND_Retry() {
        ...
        asyncAssert {
            XCTAssertEqual(self.preamble + """
                ...
                wsok
                create_session\r
                LS_keepalive_millis=5000&LS_cid=\(LS_TEST_CID)&LS_old_session=sid&LS_send_sync=false&LS_cause=recovery.end.41
                """, self.io.trace)
            XCTAssertEqual(self.delegatePreamble + """
                DISCONNECTED:TRYING-RECOVERY
                DISCONNECTED:WILL-RETRY
    ...
    func testRecoveryTimeout() {
        ...
        asyncAssert {
            XCTAssertEqual("""
                ...
                wsok
                create_session\r
                LS_keepalive_millis=5000&LS_cid=\(LS_TEST_CID)&LS_old_session=sid&LS_send_sync=false&LS_cause=recovery.timeout
                """, self.io.trace)
            XCTAssertEqual(self.delegatePreamble + """
                DISCONNECTED:TRYING-RECOVERY
                DISCONNECTED:WILL-RETRY
