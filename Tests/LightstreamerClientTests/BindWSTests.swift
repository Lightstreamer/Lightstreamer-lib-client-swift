    ...
    func testCONERR_Retry() {
        ...
        asyncAssert {
            XCTAssertEqual(self.preamble + """
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_keepalive_millis=5000&LS_cid=cid&LS_old_session=sid&LS_send_sync=false&LS_cause=ws.conerr.4
                """, self.io.trace)
            XCTAssertEqual(self.delegatePreamble + """
    ...
    func testTransportTimeout_in_502_NoRecovery() {
        ...
        asyncAssert {
            XCTAssertEqual(self.preamble + """
                ...
                ws.init http://server/lightstreamer
                wsok
                create_session\r\nLS_keepalive_millis=5000&LS_cid=cid&LS_old_session=sid&LS_send_sync=false&LS_cause=ws.timeout
                """, self.io.trace)
            XCTAssertEqual(self.delegatePreamble + """
                DISCONNECTED:WILL-RETRY
                CONNECTING
