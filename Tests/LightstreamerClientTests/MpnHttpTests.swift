    ...
    func testRestoreToken() {
        ...
        asyncAssert {
            XCTAssertEqual(self.preamble + """
                ...
                http.dispose
                http.send http://server/lightstreamer/bind_session.txt?LS_protocol=TLCP-2.3.0
                LS_session=sid2&LS_content_length=50000000&LS_keepalive_millis=5000&LS_send_sync=false&LS_cause=http.loop
                ctrl.send http://server/lightstreamer/control.txt?LS_protocol=TLCP-2.3.0&LS_session=sid2
