...
final class Update2LevelTests: BaseTestCase {
    ...
    func testCOMMAND2Level_ADD_BadItemName() {
        ...
        asyncAssert {
            ...
            XCTAssertEqual("a", u.valueWithFieldPos(1))
            XCTAssertEqual("b", u.valueWithFieldPos(2))
            XCTAssertEqual("123", u.valueWithFieldPos(3))
            XCTAssertEqual("ADD", u.valueWithFieldPos(4))
            XCTAssertEqual("a", u.valueWithFieldName("f1"))
            XCTAssertEqual("b", u.valueWithFieldName("f2"))
            XCTAssertEqual("123", u.valueWithFieldName("key"))
            XCTAssertEqual("ADD", u.valueWithFieldName("command"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(3))
    ...
    func testCOMMAND2Level_ADD_UPD1Level_UPD2Level() {
        ...
        asyncAssert(after: 0.5) {
            ...
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(3))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(4))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(5))
            XCTAssertEqual(false, u.isValueChangedWithFieldPos(6))
            XCTAssertEqual(true, u.isValueChangedWithFieldName("f1"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("f2"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("key"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("command"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("f5"))
            XCTAssertEqual(false, u.isValueChangedWithFieldName("f6"))
    ...
    func testCOMMAND2Level_ADD_UPD1Level_UPD2Level_OutOfOrder() {
        ...
        asyncAssert(after: 0.5) {
            ...
            XCTAssertEqual(1, u.itemPos)
            XCTAssertEqual(false, u.isSnapshot)
            XCTAssertEqual(["f1":"A", "command":"UPDATE"], u.changedFields)
            XCTAssertEqual([1:"A",4:"UPDATE"], u.changedFieldsByPositions)
            XCTAssertEqual(["f1":"A","f2":"b","key":"item1","command":"UPDATE"], u.fields)
            XCTAssertEqual([1:"A",2:"b",3:"item1",4:"UPDATE"], u.fieldsByPositions)
            XCTAssertEqual("A", u.valueWithFieldPos(1))
            XCTAssertEqual("b", u.valueWithFieldPos(2))
            ...
            XCTAssertEqual(1, u.itemPos)
            XCTAssertEqual(true, u.isSnapshot)
            XCTAssertEqual(["f5":"c","f6":"d"], u.changedFields)
            XCTAssertEqual([5:"c",6:"d"], u.changedFieldsByPositions)
            XCTAssertEqual(["f1":"A","f2":"b","key":"item1","command":"UPDATE","f5":"c","f6":"d"], u.fields)
            XCTAssertEqual([1:"A",2:"b",3:"item1",4:"UPDATE",5:"c",6:"d"], u.fieldsByPositions)
            XCTAssertEqual("A", u.valueWithFieldPos(1))
            XCTAssertEqual("b", u.valueWithFieldPos(2))
    ...
    func testCOMMAND2Level_EOS() {
        ...
        asyncAssert {
            ...
            XCTAssertEqual("item2", u.valueWithFieldPos(3))
            XCTAssertEqual("ADD", u.valueWithFieldPos(4))
            XCTAssertEqual("c", u.valueWithFieldName("f1"))
            XCTAssertEqual("d", u.valueWithFieldName("f2"))
            XCTAssertEqual("item2", u.valueWithFieldName("key"))
            XCTAssertEqual("ADD", u.valueWithFieldName("command"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(3))
            ...
            XCTAssertEqual("e", u.valueWithFieldPos(1))
            XCTAssertEqual("f", u.valueWithFieldPos(2))
            XCTAssertEqual("item3", u.valueWithFieldPos(3))
            XCTAssertEqual("ADD", u.valueWithFieldPos(4))
            XCTAssertEqual("e", u.valueWithFieldName("f1"))
            XCTAssertEqual("f", u.valueWithFieldName("f2"))
            XCTAssertEqual("item3", u.valueWithFieldName("key"))
            XCTAssertEqual("ADD", u.valueWithFieldName("command"))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(1))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(2))
            XCTAssertEqual(true, u.isValueChangedWithFieldPos(3))
