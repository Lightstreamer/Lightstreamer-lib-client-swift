...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/apple/swift-collections", .upToNextMinor(from: "0.0.3")),
    ],
    targets: [
        ...
        .target(
            name: "LightstreamerClient",
            dependencies: ["Starscream", "Alamofire", .product(name: "OrderedCollections", package: "swift-collections")]),
        .testTarget(
