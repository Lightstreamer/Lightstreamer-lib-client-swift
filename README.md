...
To connect to a Lightstreamer Server, a [LightstreamerClient](https://sdk.lightstreamer.com/ls-swift-client/5.0.0-beta.3/api/Classes/LightstreamerClient.html) object has to be created, configured, and instructed to connect to the Lightstreamer Server. 
...
After you have an APNs account, you can create a [MPN device](https://sdk.lightstreamer.com/ls-swift-client/5.0.0-beta.3/api/Classes/MPNDevice.html), which represents a specific app running on a specific mobile device.
...
To receive notifications, you need to subscribe to a [MPN subscription](https://sdk.lightstreamer.com/ls-swift-client/5.0.0-beta.3/api/Classes/MPNSubscription.html): it contains subscription details and the listener needed to monitor its status. Real-time data is routed via native push notifications.
...
- [API Reference](https://sdk.lightstreamer.com/ls-swift-client/5.0.0-beta.3/api/index.html)
